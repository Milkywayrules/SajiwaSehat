<!-- =================================== start: left_navbar =================================== -->
      ...
      <li class="nav-item <?php if ($sidebarActive == 'kelolaStaff') { echo "active"; } ?>">
        <a class="nav-link " href="<?php echo base_url("{$modules}/manage/staff") ?>">
      ...
      <li class="nav-item <?php if ($sidebarActive == 'uploadFile') { echo "active"; } ?>">
        <a class="nav-link " href="<?php echo base_url("{$modules}/upload-file/hub") ?>">
          <i class="fas fa-fw fa-file-upload"></i>
          <span>Upload File Hub</span>
        </a>
      </li>
