  ...
  public function hub()
	{
		...
		$data['view_hub'] = (object)array(
			...
			'tabTitle'				=> 'Upload File Hub', // must have (page title)
			'subTitle'				=> 'Select upload modules', // must have (sub title)
			'contentViewFile'	=> "{$this->controller}/v_upload_file_hub", // must have (file name for content)
